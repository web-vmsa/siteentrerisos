...
{
    $result = array();
    $result[] = array('caption' => '<b>AÇÕES</b>', 'short_caption' => 'Ações', 'filename' => 'acoes.php', 'name' => 'acoes', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => '<b>DOUTORES</b>', 'short_caption' => 'Doutores', 'filename' => 'doutores.php', 'name' => 'doutores', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => '<b>USUÁRIOS</b>', 'short_caption' => 'Usuários', 'filename' => 'usuarios.php', 'name' => 'usuarios', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    if ($success) {
       $message = "Um novo registro foi adicionado com sucesso!";
